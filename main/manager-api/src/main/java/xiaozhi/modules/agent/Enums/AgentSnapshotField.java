...
public enum AgentSnapshotField {
    ...
    COMPANION_ENABLED("companionEnabled", AgentSnapshotDataDTO::getCompanionEnabled,
            AgentUpdateDTO::getCompanionEnabled, null),
    PERSONA_ID("personaId", AgentSnapshotDataDTO::getPersonaId, AgentUpdateDTO::getPersonaId, null),
    PERSONA_VERSION("personaVersion", AgentSnapshotDataDTO::getPersonaVersion,
            AgentUpdateDTO::getPersonaVersion, null),
    COMPANION_OVERLAY("companionOverlay", AgentSnapshotDataDTO::getCompanionOverlay,
            AgentUpdateDTO::getCompanionOverlay, null),
