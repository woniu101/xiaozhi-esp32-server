...
class TimbreServiceImplTest {
    ...
    void defaultLanguageUsesFirstValidRegularTimbreLanguageWithoutCloneQuery() {
        ...
        TimbreServiceImpl service = newService(timbreDao, voiceCloneDao, mock(RedisUtils.class));
    ...
    void updateLeavesSortOutOfTheUpdateWhenRequestOmitsIt() {
        ...
        TimbreServiceImpl service = newService(timbreDao, mock(VoiceCloneDao.class), redisUtils);
    ...
    void updateUsesExplicitSortWithoutLoadingExistingTimbre() {
        TimbreDao timbreDao = mock(TimbreDao.class);
        TimbreServiceImpl service = newService(
    ...
    private TimbreServiceImpl newService(
            TimbreDao timbreDao,
