export default {
  ...
  'header.personaLibrary': 'Personas',
  ...
  // Persona library
  'persona.title': 'Persona Library',
  'persona.subtitle': 'Import from the dot-skill gallery or a ZIP, compile and test automatically, then enable it for an agent.',
  'persona.importUrl': 'Import GitHub',
  'persona.uploadZip': 'Upload ZIP',
  'persona.identityNotice': 'This is an AI companion, not the real person. Persona identity and relationship mode are configured independently.',
  'persona.compiler_checking': 'Checking compiler',
  'persona.compiler_online': 'Compiler online',
  'persona.compiler_offline': 'Compiler offline',
  'persona.compilerCheckingHint': 'Checking the Persona Compiler service',
  'persona.compilerOnlineHint': 'Persona Compiler is available. Personas can be imported.',
  'persona.compilerOfflineHint': 'Persona Compiler is unavailable. Start xiaozhi-server and check port 8003.',
  'persona.compilerFailureHelp': 'The skill was fetched, but the compiler is unavailable. Import it again after the service recovers.',
  'persona.recheckCompiler': 'Check again',
  'persona.kind_fictional': 'Fictional',
  'persona.kind_real_person': 'Real-person inspired',
  'persona.kind_public_figure': 'Public figure',
  'persona.kind_unverified': 'Unverified type',
  'persona.myLibrary': 'My Personas',
  'persona.onlineGallery': 'Online Gallery',
  'persona.searchMine': 'Search name, Persona ID, or description',
  'persona.searchGallery': 'Search people, tags, or personality',
  'persona.refresh': 'Refresh',
  'persona.search': 'Search',
  'persona.published': 'Published',
  'persona.draft': 'Draft',
  'persona.enabled': 'In use',
  'persona.notEnabled': 'Ready to enable',
  'persona.updatePending': 'Update ready',
  'persona.noDescription': 'No description',
  'persona.ceiling': 'Persona supported ceiling',
  'persona.manageVersions': 'Manage versions',
  'persona.managePersona': 'Manage persona',
  'persona.importNewVersion': 'Import version',
  'persona.upgradeTitle': 'Upgrade persona',
  'persona.upgradeBehaviorHint': 'An import creates a pending update without changing the persona in use. Applying it switches bound agents automatically while preserving relationship and memory.',
  'persona.upgradeTargetHint': 'The new version must belong to {id}. A mismatched Persona ID is rejected before persistence.',
  'persona.upgradeFromSource': 'Check the original GitHub source',
  'persona.upgradeFromZip': 'Upload a new dot-skill ZIP',
  'persona.upgradeZipHint': 'ZIP only, up to 10MB. Its Persona ID must match the target.',
  'persona.bindAgent': 'Bind agent',
  'persona.emptyMine': 'No personas yet. Import one from the gallery or upload a dot-skill ZIP.',
  'persona.emptyGallery': 'No compatible persona found',
  'persona.viewSource': 'View source',
  'persona.oneClickImport': 'Import',
  'persona.importUrlTitle': 'Import dot-skill from GitHub',
  'persona.githubUrl': 'GitHub repository URL',
  'persona.gitRef': 'Branch, tag, or commit (optional)',
  'persona.gitRefHint': 'Leave blank for the default branch',
  'persona.beginInspect': 'Inspect',
  'persona.githubRequired': 'Enter a valid GitHub HTTPS URL',
  'persona.zipInvalid': 'Only ZIP files up to 10MB are supported',
  'persona.importProgress': 'Import, test, and enable',
  'persona.stepSource': 'Source',
  'persona.stepCompile': 'Compile',
  'persona.stepReady': 'Enable',
  'persona.personaId': 'Persona ID',
  'persona.version': 'Version',
  'persona.score': 'Score',
  'persona.publishGate': 'Enable check',
  'persona.runtimePrompt': 'Runtime prompt',
  'persona.canonicalSpec': 'Canonical spec',
  'persona.validationReport': 'Validation report',
  'persona.private': 'Private',
  'persona.shared': 'Shared with all users',
  'persona.publish': 'Apply update',
  'persona.applyUpdate': 'Apply update',
  'persona.publishSuccess': 'Persona update applied',
  'persona.publishedVersion': 'Current version',
  'persona.currentVersion': 'Current persona',
  'persona.internalVersion': 'Internal version',
  'persona.lifecycleTitle': 'Persona state',
  'persona.lifecycleRole': 'Purpose',
  'persona.lifecycle_current': 'Current',
  'persona.lifecycle_candidate': 'Pending update',
  'persona.lifecycle_previous': 'Previous',
  'persona.comparePending': 'Review update',
  'persona.restorePrevious': 'Restore previous',
  'persona.restorePreviousConfirm': 'Bound agents will switch to the previous persona. Relationship and memory stay unchanged. Continue?',
  'persona.status': 'Status',
  'persona.test': 'Test',
  'persona.actions': 'Actions',
  'persona.preview': 'Preview',
  'persona.rollback': 'Rollback',
  'persona.archive': 'Archive',
  'persona.rollbackSuccess': 'Previous persona restored; bound agents will follow it automatically',
  'persona.archiveSuccess': 'Version archived',
  'persona.archiveConfirm': 'Archive this version? Archived versions cannot be published.',
  'persona.recompile': 'Recompile',
  'persona.recompileTitle': 'Recompile with the current compiler',
  'persona.recompileHint': 'Recompile the exact source saved for {version}. The old version remains immutable; changed output creates an -r2, -r3, and so on.',
  'persona.compilerVersion': 'Original compiler',
  'persona.sourceCommit': 'Source commit',
  'persona.inheritSignatureAudio': 'Carry forward compatible signature recordings',
  'persona.inheritSignatureAudioHint': 'A recording is copied only when both the signature ID and exact model output are unchanged. Manual rule overrides are not copied.',
  'persona.recompileFromSnapshot': 'Use the saved source',
  'persona.recompileFromSnapshotHint': 'Uses the imported ZIP snapshot first, then the exact recorded GitHub commit when no snapshot is available.',
  'persona.recompileFromZip': 'Upload the original ZIP',
  'persona.recompileZipHint': 'Fallback for missing historical snapshots. The ZIP must match the original source hash.',
  'persona.recompileUnchanged': 'The current compiler produced the same output; no duplicate revision was created.',
  'persona.recompileCreated': 'Created pending update {version} and safely carried forward {count} signature recordings. Review it before applying.',
  'persona.reviewRevisionDiff': 'Review revision diff',
  'persona.deletePersona': 'Delete persona',
  'persona.deletePersonaHint': 'Permanently delete the persona, source snapshots, signature recordings, relationship, and memory, and automatically unbind agents. This cannot be undone.',
  'persona.deleteBlockedTitle': 'Persona is still in use',
  'persona.deleteBlocked': 'This persona is bound to {count} agents. Your agents: {names}; other users: {external}. Unbind it in role configuration first.',
  'persona.deleteConfirm': 'Permanently delete all data for “{name}” and unbind {count} agents. Type Persona ID “{id}” to confirm.',
  'persona.confirmDelete': 'Delete persona',
  'persona.deleteIdMismatch': 'The Persona ID does not match',
  'persona.deleteSuccess': 'Persona and all related data were permanently deleted',
  'persona.purgePersona': 'Permanently purge persona',
  'persona.purgePersonaHint': 'Development tool: unbind every agent and permanently remove versions, imports, snapshots, recordings, relationship state, and memories. This cannot be undone.',
  'persona.purgeConfirm': 'Permanently purge all data for “{name}”. Type “PURGE {id}” to confirm.',
  'persona.confirmPurge': 'Permanently purge',
  'persona.purgePhraseMismatch': 'The confirmation text does not match',
  'persona.purgeSuccess': 'Persona and all development data were permanently purged',
  'persona.versionPreview': 'Version preview',
  'persona.testReport': 'Test report',
  'persona.rerunTest': 'Rerun test',
  'persona.conversationTest': 'Conversation eval',
  'persona.conversationTestHint': 'Paste recorded or replayed turns. Raw dialogue is not retained in the report; up to 500 turns.',
  'persona.conversationTestPlaceholder': 'JSON array; each item may contain scene, user, assistant, and expected.',
  'persona.runConversationTest': 'Run conversation eval',
  'persona.conversationTestInvalid': 'Enter a valid JSON array containing 1 to 500 conversation samples',
  'persona.testPassed': 'Scenario suite passed; the update can be applied',
  'persona.testFailed': 'Scenario suite failed; inspect the report',
  'persona.judgeReport': 'Judge LLM report',
  'persona.status_queued': 'Queued',
  'persona.status_resolving_source': 'Resolving source',
  'persona.status_downloading': 'Downloading immutable snapshot',
  'persona.status_inspecting': 'Inspecting dot-skill structure',
  'persona.status_compiling': 'Compiling',
  'persona.status_validating': 'Running validation and tests',
  'persona.status_ready': 'Passed and ready to enable',
  'persona.status_validation_failed': 'Publish gate failed; inspect the report',
  'persona.status_failed': 'Import failed',
  'persona.status_cancelled': 'Import cancelled',
  'persona.cancelImport': 'Cancel import',
  'persona.importCancelled': 'Import job cancelled',
  'persona.chooseAgent': 'Choose an agent',
  'persona.chooseAgentHint': 'Continue to role configuration to review and save',
  'persona.continueConfig': 'Continue',
  'persona.versions': 'Persona versions',
  'persona.fromVersion': 'From',
  'persona.toVersion': 'To',
  'persona.compare': 'Compare',
  'persona.versionDiff': 'Version diff',
  'persona.field': 'Field',
  'persona.before': 'Before',
  'persona.after': 'After',
  'persona.operationFailed': 'Persona operation failed',
  'persona.serviceUnavailable': 'Persona service is temporarily unavailable',
  'persona.auditTrail': 'Audit trail',
  'persona.time': 'Time',
  'persona.action': 'Action',
  'persona.target': 'Target',
  'persona.signatureManager': 'Signature audio',
  'persona.signatureManagerHint': 'Persona semantics decide when to trigger. A matching recording is played when available; otherwise the current TTS is used.',
  'persona.addSignature': 'Add signature',
  'persona.emptySignatures': 'This version has no signature utterances, which is a valid optional state. Add one manually or import a Skill with an explicit signature rule.',
  'persona.customSignature': 'Custom',
  'persona.signatureEnabled': 'Enabled',
  'persona.signatureDisabled': 'Disabled',
  'persona.enableSignature': 'Enable',
  'persona.disableSignature': 'Disable',
  'persona.signatureToggleSuccess': 'Signature state updated',
  'persona.signatureAliases': 'Output aliases',
  'persona.listen': 'Preview',
  'persona.replaceAudio': 'Replace',
  'persona.deleteAudio': 'Delete',
  'persona.uploadAudio': 'Upload audio',
  'persona.editRule': 'Edit rule',
  'persona.editSignature': 'Edit signature utterance',
  'persona.signatureId': 'Signature ID',
  'persona.signatureText': 'Exact model output',
  'persona.signatureRule': 'Semantic trigger rule',
  'persona.signatureRuleHint': 'Describe the unambiguous context in which this utterance is appropriate.',
  'persona.signatureAliasesHint': 'Comma-separated output aliases, for example Ciallo',
  'persona.signatureExamples': 'Positive examples',
  'persona.signatureExamplesHint': 'One example user message per line',
  'persona.signatureIdInvalid': 'The ID may only contain letters, numbers, dots, underscores, and hyphens',
  'persona.signatureRequired': 'Output text and semantic trigger rule are required',
  'persona.signatureSaved': 'Signature utterance saved; runtime caches will refresh automatically',
  'persona.signatureAudioInvalid': 'Upload a WAV, MP3, or OGG file no larger than 5MB',
  'persona.signatureAudioSaved': 'Signature recording saved',
  'persona.signaturePreviewFailed': 'Unable to preview the signature recording',
  'persona.deleteSignatureAudioConfirm': 'Delete this recording variant? Missing variants fall back to the current TTS.',
  'persona.signatureVariant_classic': 'Main',
  'persona.signatureVariant_playful': 'Playful',
  'persona.signatureVariant_soft': 'Soft',
  'persona.signatureRecordings': 'Fixed recordings',
  'persona.signatureAudioAnchorHint': 'Fixed recordings are entirely optional; missing audio uses the current TTS. Record only the exact signature utterance, while the dialogue model generates the lead-in and context.',
  'persona.saveBeforeUpload': 'Save before uploading',
  'persona.skillSignatureReadOnly': 'This is the original rule parsed from the Skill. You can upload recordings directly, or explicitly create a version-scoped override to edit the rule.',
  'persona.skillSignatureOverrideHint': 'Saving creates a version-scoped override. Future recompiles will not automatically carry this manual rule forward.',
  'persona.customizeSignatureRule': 'Create rule override',
  ...
  'roleConfig.companion': 'Persona Relationship & Memory',
  'roleConfig.companionEnabled': 'Enable Companion Core',
  'roleConfig.personaIdPlaceholder': 'Choose a published persona',
  'roleConfig.openPersonaLibrary': 'Library / Import',
  'roleConfig.personaFollowsCurrent': 'Always follows the persona currently in use and switches automatically after updates or restores',
  'roleConfig.userAddressPlaceholder': 'How the companion addresses the user',
  'roleConfig.initialStage': 'Initial relationship',
  'roleConfig.relationshipMode': 'Choose relationship mode',
  'roleConfig.relationshipModeFriend': 'Friend (up to friend)',
  'roleConfig.relationshipModeRomance': 'Romance (up to lover)',
  'roleConfig.relationshipModeDeep': 'Deep companion (up to intimate)',
  'roleConfig.relationshipModeCustom': 'Custom stages',
  'roleConfig.relationshipModeStages': 'Available stages',
  'roleConfig.allowedStages': 'Choose allowed relationship stages',
  'roleConfig.voiceReplyStyle': 'Voice reply style, e.g. short, natural, no lectures',
  'roleConfig.toolAckPrefix': 'Short acknowledgement before a device action',
  'roleConfig.proactiveEnabled': 'Enable proactive care',
  'roleConfig.proactiveHint': 'Runs only while online and avoids speech and quiet hours',
  'roleConfig.proactiveInterval': 'Minimum interval (minutes)',
  'roleConfig.proactiveDailyLimit': 'Daily limit',
  'roleConfig.proactiveQuietHours': 'Quiet hours',
  'roleConfig.proactiveTimezone': 'Time zone',
  'roleConfig.proactiveMaxUnanswered': 'Unanswered limit',
  'roleConfig.proactiveRejectionCooldown': 'Cooldown after rejection (minutes)',
  'roleConfig.advancedOverlay': 'Advanced JSON',
  'roleConfig.stage_stranger': 'Stranger',
  'roleConfig.stage_familiar': 'Familiar',
  'roleConfig.stage_friend': 'Friend',
  'roleConfig.stage_ambiguous': 'Romantic tension',
  'roleConfig.stage_lover': 'Lover',
  'roleConfig.stage_intimate': 'Intimate',
  'roleConfig.companionOverlayPlaceholder': 'Companion Overlay JSON (boundaries, address, voice length)',
  'roleConfig.personaIdRequired': 'Enter a Persona ID before enabling Companion Core',
  'roleConfig.companionOverlayInvalid': 'Companion Overlay must be a valid JSON object',
  'roleConfig.companionSummary': 'Stage: {stage}; turns: {turns}; memories: {memories}',
  'roleConfig.resetCompanionRelationship': 'Reset relationship only',
  'roleConfig.resetCompanionRelationshipConfirm': 'Reset the relationship to its configured initial stage while keeping persona memories?',
  'roleConfig.resetCompanionRelationshipSuccess': 'Relationship reset; persona memories were kept',
  'roleConfig.resetCompanionState': 'Reset state and memories',
  'roleConfig.openCompanionDiagnostic': 'Latest turn diagnostic',
  'roleConfig.companionDiagnosticTitle': 'Latest Companion Turn Diagnostic',
  'roleConfig.companionDiagnosticHint': 'Shows only the response plan, events, memory IDs, and timing; raw dialogue is not stored.',
  'roleConfig.companionDiagnosticFailed': 'Failed to load the latest turn diagnostic',
  'roleConfig.resetCompanionConfirm': 'This permanently deletes the relationship state, events, and memories for this agent. Continue?',
  'roleConfig.resetCompanionSuccess': 'Companion state and memories were reset',
  'roleConfig.resetCompanionFailed': 'Failed to reset Companion state',
  'roleConfig.tooltip.companion': 'Bind a compiled dot-skill Persona to this agent. Internal relationship scores are not editable.',
  ...
  'roleConfig.reset': 'Discard Unsaved Changes',
  'roleConfig.agentName': 'Nickname',
  'roleConfig.roleTemplate': 'Template',
  'roleConfig.roleIntroduction': 'Base System Rules',
