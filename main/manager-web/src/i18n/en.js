export default {
  ...
  'persona.subtitle': 'Import from the dot-skill gallery or a ZIP, compile and test automatically, then publish and bind it to an agent.',
  ...
  'persona.importProgress': 'Import, test, and publish',
  'persona.stepSource': 'Source',
  'persona.stepCompile': 'Compile',
  'persona.stepReady': 'Publish',
  'persona.personaId': 'Persona ID',
  'persona.version': 'Version',
  'persona.score': 'Score',
  'persona.publishGate': 'Publish gate',
  ...
  'persona.publish': 'Publish',
  'persona.publishSuccess': 'Persona version published',
  ...
  'persona.rollbackSuccess': 'Published pointer updated',
  ...
  'persona.testPassed': 'Scenario suite passed; this version can be published',
  ...
  'persona.status_ready': 'Passed and ready to publish',
  ...
  'roleConfig.personaVersionPlaceholder': 'Pin a version (blank follows current published)',
  'roleConfig.openPersonaLibrary': 'Library / Import',
  'roleConfig.personaLatestVersion': 'Follow current published version',
