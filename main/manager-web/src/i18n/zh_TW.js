export default {
  ...
  'modelConfigDialog.testConnection': '測試連線',
  'modelConfigDialog.testConnectionHint': '使用目前表單值檢測，不會儲存設定',
  'modelConfigDialog.testConnectionFailed': '連線測試失敗',
  'modelConfigDialog.healthCheck': '健康檢查',
  ...
  // dot-skill 人物風格與可選招牌語音
  'characterStyle.title': '人物風格',
  'characterStyle.tooltip': '匯入並綁定 dot-skill；綁定後人物風格與原角色介紹在執行時互斥',
  'characterStyle.unbound': '未綁定人物風格',
  'characterStyle.bind': '綁定',
  'characterStyle.unbind': '解除綁定',
  'characterStyle.manage': '匯入與管理',
  'characterStyle.boundNotice': '原角色介紹已保留但目前不生效；解除綁定後會恢復。',
  'characterStyle.optionalHelp': '可選；不綁定時繼續使用原角色範本與角色介紹。',
  'characterStyle.libraryTitle': '人物風格庫',
  'characterStyle.library': '人物列表與診斷',
  'characterStyle.bound': '已綁定',
  'characterStyle.delete': '刪除',
  'characterStyle.empty': '尚未匯入人物風格',
  'characterStyle.zipSource': '本機 ZIP 匯入',
  'characterStyle.sourceHash': '來源雜湊',
  'characterStyle.sourceRef': '分支 / 標籤 / commit',
  'characterStyle.includedFiles': '納入的引用檔案',
  'characterStyle.characterCount': '原文 / 最終字元數',
  'characterStyle.rawSkill': '原始 SKILL.md',
  'characterStyle.finalPrompt': '最終提示詞',
  'characterStyle.diagnostics': '匯入診斷',
  'characterStyle.selectToView': '選擇一個人物風格查看',
  'characterStyle.importUpdate': '匯入 / 原子更新',
  'characterStyle.mode': '請先選擇本次操作',
  'characterStyle.modeImport': '匯入新人物',
  'characterStyle.modeUpdate': '更新已有人物',
  'characterStyle.importModeHelp': '建立一個新的人物風格，不會變更已有人物。',
  'characterStyle.updateModeHelp': '先選擇更新目標；新套件完整驗證通過後才原子替換，失敗時保留舊版。',
  'characterStyle.updateTarget': '更新目標',
  'characterStyle.selectUpdateTarget': '請選擇要更新的人物',
  'characterStyle.createNew': '新建人物風格',
  'characterStyle.name': '人物名稱',
  'characterStyle.importType': '匯入方式',
  'characterStyle.zipFile': 'dot-skill ZIP',
  'characterStyle.zipLimit': '僅 ZIP，最大 10MB',
  'characterStyle.sourceRefHelp': '可留空使用預設分支；也可填分支、標籤或 Commit。',
  'characterStyle.atomicUpdate': '原子更新',
  'characterStyle.import': '匯入',
  'characterStyle.signatures': '固定招牌錄音（可選增強）',
  'characterStyle.signatureOwner': '所屬人物',
  'characterStyle.signatureOwnerHelp': '設定隨該人物風格儲存，所有綁定此人物的智慧體共用。',
  'characterStyle.signatureEnabled': '啟用固定錄音替換',
  'characterStyle.signatureOptionalHelp': '這裡只改變播放來源，不決定人物何時說；關閉後招牌句仍可由目前 TTS 合成。',
  'characterStyle.flowSkill': 'Skill 判斷語境',
  'characterStyle.flowSkillHelp': '人物原文定義何時適合說',
  'characterStyle.flowLlm': 'LLM 自然輸出',
  'characterStyle.flowLlmHelp': '結合目前對話決定是否說',
  'characterStyle.flowAudio': '錄音替換片段',
  'characterStyle.flowAudioHelp': '只替換已輸出的對應台詞',
  'characterStyle.notUserTriggerHelp': '等價寫法匹配的是模型輸出，不是使用者觸發詞。不要把「想聽那個了」等使用者話術填在這裡。',
  'characterStyle.suggestFromSkill': '從 Skill 產生建議',
  'characterStyle.suggestionTitle': '待確認建議（預設不啟用）',
  'characterStyle.suggestionEvidence': '來源證據',
  'characterStyle.adoptSuggestion': '採納為草稿',
  'characterStyle.noSuggestions': '沒有找到帶明確來源證據的招牌台詞，請手動新增',
  'characterStyle.suggestionAdopted': '建議已新增為未啟用草稿，請核對台詞並上傳對應錄音',
  'characterStyle.addSignature': '新增錄音映射',
  'characterStyle.itemEnabled': '啟用此錄音',
  'characterStyle.displayText': '錄音對應台詞',
  'characterStyle.displayTextHelp': '應與 WAV 實際說出的片段一致；前搖和後續文字繼續由目前 TTS 合成。',
  'characterStyle.aliases': '模型輸出的等價寫法',
  'characterStyle.aliasesHelp': '只填寫標點、全半形或大小寫等同義呈現，以逗號分隔；不是使用者觸發詞。',
  'characterStyle.recordingReady': '固定錄音已就緒',
  'characterStyle.recordingUploadedDisabled': '錄音已上傳，目前未啟用',
  'characterStyle.recordingDisabledWarning': '設定已儲存，但有錄音尚未啟用；這些台詞仍會使用目前 TTS。',
  'characterStyle.audioUploadDisabled': '錄音上傳成功，請開啟「啟用此錄音」並儲存設定。',
  'characterStyle.useCurrentTts': '使用目前 TTS',
  'characterStyle.replaceAudio': '替換錄音',
  'characterStyle.uploadAudio': '上傳錄音',
  'characterStyle.preview': '試聽',
  'characterStyle.deleteAudio': '刪除錄音',
  'characterStyle.removeExpression': '移除表達',
  'characterStyle.zeroSignatures': '可以保留零條表達，人物匯入和綁定不受影響',
  'characterStyle.saveSignatures': '儲存固定錄音設定',
  'characterStyle.contextTrial': '上下文試跑',
  'characterStyle.contextTrialHelp': '使用目前智慧體的主語言模型和所選人物執行一次無歷史、無工具試跑，不儲存為真實對話。',
  'characterStyle.contextTrialPlaceholder': '例如：兔娘，想聽那個了',
  'characterStyle.runContextTrial': '執行試跑',
  'characterStyle.contextTrialRequired': '請輸入要試跑的使用者話語',
  'characterStyle.modelActualOutput': '模型實際輸出',
  'characterStyle.routeResult': '錄音路由結果',
  'characterStyle.fixedRecordingPlayback': '播放固定錄音',
  'characterStyle.currentTtsPlayback': '使用目前 TTS',
  'characterStyle.noSignatureMatched': '模型沒有輸出已設定台詞，本輪全部使用目前 TTS。這不代表失敗，可能是上下文不應觸發。',
  'characterStyle.operationFailed': '人物風格操作失敗',
  'characterStyle.bindSuccess': '人物風格已綁定，裝置重新連線後生效',
  'characterStyle.unbindSuccess': '已解除綁定，原角色介紹會在裝置重新連線後恢復',
  'characterStyle.deleteConfirm': '確認刪除人物風格「{name}」？',
  'characterStyle.nameRequired': '請輸入人物名稱',
  'characterStyle.githubRequired': '請輸入 GitHub 儲存庫位址',
  'characterStyle.zipRequired': '請選擇 dot-skill ZIP',
  'characterStyle.updateTargetRequired': '請先選擇要更新的人物',
  'characterStyle.atomicUpdateConfirm': '確認用新的 dot-skill 原子更新「{name}」？驗證失敗不會覆蓋舊版。',
  'characterStyle.importSuccess': '人物風格已匯入；已綁定智能體會在重新連線後使用新內容',
  'characterStyle.updateSuccess': '人物風格已原子更新；已綁定智能體會在重新連線後使用新內容',
  'characterStyle.signatureSaveSuccess': '招牌語音設定已儲存，裝置重新連線後生效',
  'characterStyle.wavRequired': '只允許上傳 WAV 錄音',
  'characterStyle.audioUploadSuccess': '主錄音已正規化並儲存',
  'characterStyle.rolePromptPreserved': '已綁定人物風格：此角色介紹仍被儲存，但目前不注入模型；解除綁定後恢復。',
  'characterStyle.templateDisabled': '綁定人物風格期間不能套用另一套完整角色範本，請先解除綁定。',
