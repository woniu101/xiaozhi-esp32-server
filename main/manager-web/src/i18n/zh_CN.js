export default {
  ...
  // Persona 人物库
  'persona.title': 'Persona 人物库',
  'persona.subtitle': '从 dot-skill 画廊或 ZIP 导入，自动编译测试，启用后即可绑定智能体。',
  'persona.importUrl': 'GitHub 导入',
  'persona.uploadZip': '上传 ZIP',
  'persona.identityNotice': '这是一位 AI 伴侣，不是真人本人。人物身份与关系模式相互独立，关系范围在绑定智能体时选择。',
  'persona.compiler_checking': '检测编译器',
  'persona.compiler_online': '编译器正常',
  'persona.compiler_offline': '编译器离线',
  'persona.compilerCheckingHint': '正在检测 Persona Compiler 服务',
  'persona.compilerOnlineHint': 'Persona Compiler 可用，可以导入人物',
  'persona.compilerOfflineHint': 'Persona Compiler 不可用，请先启动 xiaozhi-server 并检查 8003 端口',
  'persona.compilerFailureHelp': 'Skill 已获取，但编译服务不可用；服务恢复后请重新导入。',
  'persona.recheckCompiler': '重新检测',
  'persona.kind_fictional': '虚构人物',
  'persona.kind_real_person': '真人原型',
  'persona.kind_public_figure': '公众人物',
  'persona.kind_unverified': '未验证类型',
  'persona.myLibrary': '我的人物',
  'persona.onlineGallery': '在线画廊',
  'persona.searchMine': '搜索名称、Persona ID 或描述',
  'persona.searchGallery': '搜索画廊人物、标签或性格',
  'persona.refresh': '刷新',
  'persona.search': '搜索',
  'persona.published': '已发布',
  'persona.draft': '草稿',
  'persona.enabled': '使用中',
  'persona.notEnabled': '待启用',
  'persona.updatePending': '有更新',
  'persona.noDescription': '暂无描述',
  'persona.ceiling': '人物支持上限',
  'persona.manageVersions': '管理版本',
  'persona.managePersona': '管理人物',
  'persona.importNewVersion': '导入新版',
  'persona.upgradeTitle': '人物升级',
  'persona.upgradeBehaviorHint': '导入后生成“待应用更新”，不会影响正在使用的人物。确认应用后，已绑定智能体自动使用新版，关系与记忆保持不变。',
  'persona.upgradeTargetHint': '新版必须属于 {id}，Persona ID 不一致时会在入库前拦截。',
  'persona.upgradeFromSource': '从原 GitHub 来源检查更新',
  'persona.upgradeFromZip': '上传新版 dot-skill ZIP',
  'persona.upgradeZipHint': '仅支持不超过 10MB 的 ZIP；包内 Persona ID 必须与目标一致。',
  'persona.bindAgent': '绑定智能体',
  'persona.emptyMine': '还没有人物，先从画廊导入或上传 dot-skill ZIP',
  'persona.emptyGallery': '没有找到可导入的人物',
  'persona.viewSource': '查看来源',
  'persona.oneClickImport': '一键导入',
  'persona.importUrlTitle': '从 GitHub 导入 dot-skill',
  'persona.githubUrl': 'GitHub 仓库地址',
  'persona.gitRef': '分支、标签或提交（可选）',
  'persona.gitRefHint': '留空使用仓库默认分支',
  'persona.beginInspect': '开始检查',
  'persona.githubRequired': '请输入合法的 GitHub HTTPS 地址',
  'persona.zipInvalid': '仅支持不超过 10MB 的 ZIP 文件',
  'persona.importProgress': '导入、测试与启用',
  'persona.stepSource': '获取来源',
  'persona.stepCompile': '编译测试',
  'persona.stepReady': '启用',
  'persona.personaId': 'Persona ID',
  'persona.version': '版本',
  'persona.score': '质量分',
  'persona.publishGate': '启用检查',
  'persona.runtimePrompt': '运行时提示词',
  'persona.canonicalSpec': '标准人物规格',
  'persona.validationReport': '校验报告',
  'persona.private': '仅自己可见',
  'persona.shared': '共享给所有用户',
  'persona.publish': '应用更新',
  'persona.applyUpdate': '应用更新',
  'persona.publishSuccess': '人物更新已应用',
  'persona.publishedVersion': '当前使用版本',
  'persona.currentVersion': '当前使用',
  'persona.internalVersion': '内部版本',
  'persona.lifecycleTitle': '当前人物',
  'persona.lifecycleRole': '用途',
  'persona.lifecycle_current': '当前使用',
  'persona.lifecycle_candidate': '待应用更新',
  'persona.lifecycle_previous': '上一版',
  'persona.comparePending': '查看更新内容',
  'persona.restorePrevious': '恢复上一版',
  'persona.restorePreviousConfirm': '恢复上一版后，已绑定智能体会自动切换；关系与记忆不会改变。继续吗？',
  'persona.status': '状态',
  'persona.test': '测试',
  'persona.actions': '操作',
  'persona.preview': '预览',
  'persona.rollback': '回滚',
  'persona.archive': '归档',
  'persona.rollbackSuccess': '已恢复上一版，已绑定智能体会自动跟随',
  'persona.archiveSuccess': '版本已归档',
  'persona.archiveConfirm': '确认归档这个版本？归档后不能再发布。',
  'persona.recompile': '重新解析',
  'persona.recompileTitle': '使用当前编译器重新解析',
  'persona.recompileHint': '以 {version} 保存的同一份源码重新编译。旧版本不会被覆盖；结果有变化时会生成 -r2、-r3 等修订版。',
  'persona.compilerVersion': '原编译器版本',
  'persona.sourceCommit': '源码 commit',
  'persona.inheritSignatureAudio': '继承仍然匹配的招牌录音',
  'persona.inheritSignatureAudioHint': '仅当表达 ID 和模型输出原文都未变化时复制录音；手工规则覆盖不会继承。',
  'persona.recompileFromSnapshot': '用保存的源码重新解析',
  'persona.recompileFromSnapshotHint': '优先使用导入时的 ZIP 快照；没有快照时使用该版本记录的 GitHub commit。',
  'persona.recompileFromZip': '上传原版本 ZIP',
  'persona.recompileZipHint': '仅用于历史快照缺失；ZIP 内容必须与该版本的源码哈希一致。',
  'persona.recompileUnchanged': '当前编译器的输出与这个版本一致，没有创建重复修订版。',
  'persona.recompileCreated': '已生成待应用更新 {version}，并安全继承 {count} 条招牌录音；请检查差异和测试后再应用。',
  'persona.reviewRevisionDiff': '查看修订差异',
  'persona.deletePersona': '删除人物',
  'persona.deletePersonaHint': '永久删除人物、源码快照、招牌录音、关系与记忆，并自动解除智能体绑定。此操作不可恢复。',
  'persona.deleteBlockedTitle': '暂时不能删除',
  'persona.deleteBlocked': '该人物仍被 {count} 个智能体绑定。你的智能体：{names}；其他用户占用：{external}。请先在角色配置中解除绑定。',
  'persona.deleteConfirm': '将永久删除“{name}”的全部人物数据，并自动解除 {count} 个智能体绑定。请输入 Persona ID“{id}”确认。',
  'persona.confirmDelete': '确认删除',
  'persona.deleteIdMismatch': '输入的 Persona ID 不匹配',
  'persona.deleteSuccess': '人物及其全部数据已永久删除',
  'persona.purgePersona': '彻底清除人物',
  'persona.purgePersonaHint': '开发工具：解除全部绑定，并永久删除人物版本、导入记录、源码快照、招牌录音、关系状态与记忆。此操作不可恢复。',
  'persona.purgeConfirm': '即将永久清除“{name}”的全部数据。请输入“PURGE {id}”确认。',
  'persona.confirmPurge': '永久清除',
  'persona.purgePhraseMismatch': '确认文本不匹配',
  'persona.purgeSuccess': '人物及其全部开发数据已彻底清除',
  'persona.versionPreview': '版本预览',
  'persona.testReport': '测试报告',
  'persona.rerunTest': '重跑测试',
  'persona.conversationTest': '对话评测',
  'persona.conversationTestHint': '粘贴真实或回放对话样本；报告不保存原始对话，只保存问题类型和统计。最多 500 轮。',
  'persona.conversationTestPlaceholder': 'JSON 数组，每项可包含 scene、user、assistant、expected。',
  'persona.runConversationTest': '运行对话评测',
  'persona.conversationTestInvalid': '请输入 1 到 500 条合法 JSON 对话样本',
  'persona.testPassed': '场景测试通过，可以应用更新',
  'persona.testFailed': '场景测试未通过，请查看报告',
  'persona.judgeReport': 'Judge LLM 评审报告',
  'persona.status_queued': '任务排队中',
  'persona.status_resolving_source': '正在解析来源',
  'persona.status_downloading': '正在下载安全快照',
  'persona.status_inspecting': '正在识别 dot-skill 结构',
  'persona.status_compiling': '正在编译',
  'persona.status_validating': '正在执行校验和测试',
  'persona.status_ready': '已通过，可以启用',
  'persona.status_validation_failed': '未通过发布门禁，请查看报告',
  'persona.status_failed': '导入失败',
  'persona.status_cancelled': '导入已取消',
  'persona.cancelImport': '取消导入',
  'persona.importCancelled': '导入任务已取消',
  'persona.chooseAgent': '选择要绑定的智能体',
  'persona.chooseAgentHint': '选择智能体后进入角色配置确认并保存',
  'persona.continueConfig': '继续配置',
  'persona.versions': '人物版本',
  'persona.fromVersion': '起始版本',
  'persona.toVersion': '目标版本',
  'persona.compare': '对比',
  'persona.versionDiff': '版本差异',
  'persona.field': '字段',
  'persona.before': '变更前',
  'persona.after': '变更后',
  'persona.operationFailed': 'Persona 操作失败',
  'persona.serviceUnavailable': 'Persona 服务暂时不可用',
  'persona.auditTrail': '审计记录',
  'persona.time': '时间',
  'persona.action': '操作类型',
  'persona.target': '目标',
  'persona.signatureManager': '招牌语音',
  'persona.signatureManagerHint': '语义触发由人物规则决定；命中后优先播放固定录音，未上传的语气自动回退当前 TTS。',
  'persona.addSignature': '新增招牌表达',
  'persona.emptySignatures': '当前版本没有招牌表达，这是正常的可选状态；也可以手工新增或导入明确包含招牌规则的 Skill',
  'persona.customSignature': '自定义',
  'persona.signatureEnabled': '已启用',
  'persona.signatureDisabled': '已禁用',
  'persona.enableSignature': '启用',
  'persona.disableSignature': '禁用',
  'persona.signatureToggleSuccess': '招牌表达状态已更新',
  'persona.signatureAliases': '识别别名',
  'persona.listen': '试听',
  'persona.replaceAudio': '替换',
  'persona.deleteAudio': '删除',
  'persona.uploadAudio': '上传录音',
  'persona.editRule': '编辑规则',
  'persona.editSignature': '编辑招牌表达',
  'persona.signatureId': '表达 ID',
  'persona.signatureText': '模型应输出的原文',
  'persona.signatureRule': '语义触发规则',
  'persona.signatureRuleHint': '描述应该在什么语境使用；不确定时不触发，不要只填关键词。',
  'persona.signatureAliasesHint': '用于识别模型输出，多个别名用逗号分隔，例如 Ciallo',
  'persona.signatureExamples': '正向触发示例',
  'persona.signatureExamplesHint': '每行一个用户说法，用于说明哪些语境可以触发',
  'persona.signatureIdInvalid': '表达 ID 只能包含字母、数字、点、下划线和短横线',
  'persona.signatureRequired': '表达原文和语义触发规则不能为空',
  'persona.signatureSaved': '招牌表达已保存，运行时缓存会自动更新',
  'persona.signatureAudioInvalid': '仅支持不超过 5MB 的 WAV、MP3 或 OGG 音频',
  'persona.signatureAudioSaved': '招牌录音已保存',
  'persona.signaturePreviewFailed': '招牌录音试听失败',
  'persona.deleteSignatureAudioConfirm': '确认删除这个语气版本的录音？未上传的语气会回退当前 TTS。',
  'persona.signatureVariant_classic': '主录音',
  'persona.signatureVariant_playful': '活泼',
  'persona.signatureVariant_soft': '轻柔',
  'persona.signatureRecordings': '固定录音',
  'persona.signatureAudioAnchorHint': '固定录音完全可选；未上传时使用当前 TTS 动态合成。录音只包含模型应输出的招牌原文，前摇和上下文由对话模型生成。',
  'persona.saveBeforeUpload': '先保存表达再上传',
  'persona.skillSignatureReadOnly': '这是从 Skill 解析出的原始规则。可以直接上传录音；如需改规则，请显式创建当前版本的自定义覆盖。',
  'persona.skillSignatureOverrideHint': '保存后将创建当前人物版本专属覆盖；以后重新解析不会自动继承这份手工规则。',
  'persona.customizeSignatureRule': '自定义覆盖规则',
  ...
  'roleConfig.companion': '人物关系与记忆',
  'roleConfig.companionEnabled': '启用 Companion Core',
  'roleConfig.personaIdPlaceholder': '选择已发布人物',
  'roleConfig.openPersonaLibrary': '人物库 / 导入',
  'roleConfig.personaFollowsCurrent': '始终跟随人物当前使用版本；人物更新或恢复上一版时自动切换',
  'roleConfig.userAddressPlaceholder': '对用户的称呼，例如：主人、小可爱',
  'roleConfig.initialStage': '初始关系',
  'roleConfig.relationshipMode': '选择关系模式',
  'roleConfig.relationshipModeFriend': '朋友型（最高朋友）',
  'roleConfig.relationshipModeRomance': '恋爱型（最高恋人）',
  'roleConfig.relationshipModeDeep': '深度陪伴型（最高亲密）',
  'roleConfig.relationshipModeCustom': '自定义阶段',
  'roleConfig.relationshipModeStages': '可发展阶段',
  'roleConfig.allowedStages': '选择允许发展的关系阶段',
  'roleConfig.voiceReplyStyle': '语音回复风格，例如：简短、自然、避免长篇说教',
  'roleConfig.toolAckPrefix': '执行设备操作前的简短确认，例如：好哒，马上~',
  'roleConfig.proactiveEnabled': '启用主动关心',
  'roleConfig.proactiveHint': '仅在线时触发，并自动避开用户说话和安静时段',
  'roleConfig.proactiveInterval': '最短间隔（分钟）',
  'roleConfig.proactiveDailyLimit': '每日最多次数',
  'roleConfig.proactiveQuietHours': '安静时段',
  'roleConfig.proactiveTimezone': '时区',
  'roleConfig.proactiveMaxUnanswered': '连续未回应上限',
  'roleConfig.proactiveRejectionCooldown': '拒绝后冷却（分钟）',
  'roleConfig.advancedOverlay': '高级 JSON',
  'roleConfig.stage_stranger': '初识',
  'roleConfig.stage_familiar': '熟悉',
  'roleConfig.stage_friend': '朋友',
  'roleConfig.stage_ambiguous': '暧昧',
  'roleConfig.stage_lover': '恋人',
  'roleConfig.stage_intimate': '亲密',
  'roleConfig.companionOverlayPlaceholder': 'Companion Overlay JSON（边界、称呼、语音长度等）',
  'roleConfig.personaIdRequired': '启用 Companion Core 前请填写 Persona ID',
  'roleConfig.companionOverlayInvalid': 'Companion Overlay 必须是合法的 JSON 对象',
  'roleConfig.companionSummary': '关系阶段：{stage}；有效轮次：{turns}；记忆：{memories}',
  'roleConfig.resetCompanionRelationship': '仅重置关系',
  'roleConfig.resetCompanionRelationshipConfirm': '将关系恢复到当前配置的初始阶段，但保留人物记忆。确定继续吗？',
  'roleConfig.resetCompanionRelationshipSuccess': '关系状态已重置，人物记忆已保留',
  'roleConfig.resetCompanionState': '重置状态与记忆',
  'roleConfig.openCompanionDiagnostic': '最近一轮诊断',
  'roleConfig.companionDiagnosticTitle': 'Companion 最近一轮诊断',
  'roleConfig.companionDiagnosticHint': '仅显示回应计划、事件、记忆 ID 和耗时，不保存原始对话内容。',
  'roleConfig.companionDiagnosticFailed': '获取最近一轮诊断失败',
  'roleConfig.resetCompanionConfirm': '将永久删除该角色与你形成的关系状态、事件和记忆。确定继续吗？',
  'roleConfig.resetCompanionSuccess': 'Companion 状态和记忆已重置',
  'roleConfig.resetCompanionFailed': '重置 Companion 状态失败',
  'roleConfig.tooltip.companion': '将 dot-skill 编译后的 Persona 绑定到该智能体；内部关系分数不可在此编辑。',
  ...
  'roleConfig.reset': '放弃未保存修改',
  'roleConfig.agentName': '助手昵称',
  'roleConfig.roleTemplate': '角色模版',
  'roleConfig.roleIntroduction': '基础系统规则',
  ...
  'roleConfig.memoryHis': '本地短记忆摘要',
  'roleConfig.memory': '旧版对话记忆',
