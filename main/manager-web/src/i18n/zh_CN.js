export default {
  ...
  'modelConfigDialog.testConnection': '测试连接',
  'modelConfigDialog.testConnectionHint': '使用当前表单值检测，不会保存配置',
  'modelConfigDialog.testConnectionFailed': '连接测试失败',
  'modelConfigDialog.healthCheck': '健康检查',
  ...
  // dot-skill 人物风格与可选招牌语音
  'characterStyle.title': '人物风格',
  'characterStyle.tooltip': '导入并绑定 dot-skill；绑定后人物风格与原角色介绍运行时互斥',
  'characterStyle.unbound': '未绑定人物风格',
  'characterStyle.bind': '绑定',
  'characterStyle.unbind': '解除绑定',
  'characterStyle.manage': '导入与管理',
  'characterStyle.boundNotice': '原角色介绍已保留但当前不生效；解除绑定后会恢复。',
  'characterStyle.optionalHelp': '可选；不绑定时继续使用原角色模板和角色介绍。',
  'characterStyle.libraryTitle': '人物风格库',
  'characterStyle.library': '人物列表与诊断',
  'characterStyle.bound': '已绑定',
  'characterStyle.delete': '删除',
  'characterStyle.empty': '尚未导入人物风格',
  'characterStyle.zipSource': '本地 ZIP 导入',
  'characterStyle.sourceHash': '来源哈希',
  'characterStyle.sourceRef': '分支 / 标签 / commit',
  'characterStyle.includedFiles': '纳入的引用文件',
  'characterStyle.characterCount': '原文 / 最终字符数',
  'characterStyle.rawSkill': '原始 SKILL.md',
  'characterStyle.finalPrompt': '最终提示词',
  'characterStyle.diagnostics': '导入诊断',
  'characterStyle.selectToView': '选择一个人物风格查看',
  'characterStyle.importUpdate': '导入 / 原子更新',
  'characterStyle.mode': '请先选择本次操作',
  'characterStyle.modeImport': '导入新人物',
  'characterStyle.modeUpdate': '更新已有人物',
  'characterStyle.importModeHelp': '创建一个新的人物风格，不会改动已有人物。',
  'characterStyle.updateModeHelp': '先选择更新目标；新包完整校验通过后才原子替换，失败时保留旧版。',
  'characterStyle.updateTarget': '更新目标',
  'characterStyle.selectUpdateTarget': '请选择要更新的人物',
  'characterStyle.createNew': '新建人物风格',
  'characterStyle.name': '人物名称',
  'characterStyle.importType': '导入方式',
  'characterStyle.zipFile': 'dot-skill ZIP',
  'characterStyle.zipLimit': '仅 ZIP，最大 10MB',
  'characterStyle.sourceRefHelp': '可留空使用默认分支；也可填分支、标签或 Commit。',
  'characterStyle.atomicUpdate': '原子更新',
  'characterStyle.import': '导入',
  'characterStyle.signatures': '固定招牌录音（可选增强）',
  'characterStyle.signatureOwner': '所属人物',
  'characterStyle.signatureOwnerHelp': '配置随该人物风格保存，所有绑定此人物的智能体共享。',
  'characterStyle.signatureEnabled': '启用固定录音替换',
  'characterStyle.signatureOptionalHelp': '这里只改变播放来源，不决定人物何时说；关闭后招牌句仍可由当前 TTS 合成。',
  'characterStyle.flowSkill': 'Skill 判断语境',
  'characterStyle.flowSkillHelp': '人物原文定义何时适合说',
  'characterStyle.flowLlm': 'LLM 自然输出',
  'characterStyle.flowLlmHelp': '结合当前对话决定是否说',
  'characterStyle.flowAudio': '录音替换片段',
  'characterStyle.flowAudioHelp': '只替换已输出的对应台词',
  'characterStyle.notUserTriggerHelp': '等价写法匹配的是模型输出，不是用户触发词。不要把“想听那个了”等用户话术填在这里。',
  'characterStyle.suggestFromSkill': '从 Skill 生成建议',
  'characterStyle.suggestionTitle': '待确认建议（默认不启用）',
  'characterStyle.suggestionEvidence': '来源证据',
  'characterStyle.adoptSuggestion': '采纳为草稿',
  'characterStyle.noSuggestions': '没有找到带明确来源证据的招牌台词，请手动添加',
  'characterStyle.suggestionAdopted': '建议已添加为未启用草稿，请核对台词并上传对应录音',
  'characterStyle.addSignature': '添加录音映射',
  'characterStyle.itemEnabled': '启用此录音',
  'characterStyle.displayText': '录音对应台词',
  'characterStyle.displayTextHelp': '应与 WAV 实际说出的片段一致；前摇和后续文字继续由当前 TTS 合成。',
  'characterStyle.aliases': '模型输出的等价写法',
  'characterStyle.aliasesHelp': '仅填写标点、全半角或大小写等同义呈现，用逗号分隔；不是用户触发词。',
  'characterStyle.recordingReady': '固定录音已就绪',
  'characterStyle.recordingUploadedDisabled': '录音已上传，当前未启用',
  'characterStyle.recordingDisabledWarning': '配置已保存，但有录音尚未启用；这些台词仍会使用当前 TTS。',
  'characterStyle.audioUploadDisabled': '录音上传成功，请打开“启用此录音”并保存配置。',
  'characterStyle.useCurrentTts': '使用当前 TTS',
  'characterStyle.replaceAudio': '替换录音',
  'characterStyle.uploadAudio': '上传录音',
  'characterStyle.preview': '试听',
  'characterStyle.deleteAudio': '删除录音',
  'characterStyle.removeExpression': '移除表达',
  'characterStyle.zeroSignatures': '可以保留零条表达，人物导入和绑定不受影响',
  'characterStyle.saveSignatures': '保存固定录音配置',
  'characterStyle.contextTrial': '上下文试跑',
  'characterStyle.contextTrialHelp': '使用当前智能体的主语言模型和所选人物执行一次无历史、无工具试跑，不保存为真实对话。',
  'characterStyle.contextTrialPlaceholder': '例如：兔娘，想听那个了',
  'characterStyle.runContextTrial': '运行试跑',
  'characterStyle.contextTrialRequired': '请输入要试跑的用户话语',
  'characterStyle.modelActualOutput': '模型实际输出',
  'characterStyle.routeResult': '录音路由结果',
  'characterStyle.fixedRecordingPlayback': '播放固定录音',
  'characterStyle.currentTtsPlayback': '使用当前 TTS',
  'characterStyle.noSignatureMatched': '模型没有输出已配置台词，本轮全部使用当前 TTS。这不代表失败，可能是上下文不应触发。',
  'characterStyle.operationFailed': '人物风格操作失败',
  'characterStyle.bindSuccess': '人物风格已绑定，设备重连后生效',
  'characterStyle.unbindSuccess': '已解除绑定，原角色介绍将在设备重连后恢复',
  'characterStyle.deleteConfirm': '确认删除人物风格“{name}”？',
  'characterStyle.nameRequired': '请输入人物名称',
  'characterStyle.githubRequired': '请输入 GitHub 仓库地址',
  'characterStyle.zipRequired': '请选择 dot-skill ZIP',
  'characterStyle.updateTargetRequired': '请先选择要更新的人物',
  'characterStyle.atomicUpdateConfirm': '确认用新的 dot-skill 原子更新“{name}”？校验失败不会覆盖旧版。',
  'characterStyle.importSuccess': '人物风格已导入；已绑定智能体将在重连后使用新内容',
  'characterStyle.updateSuccess': '人物风格已原子更新；已绑定智能体将在重连后使用新内容',
  'characterStyle.signatureSaveSuccess': '招牌语音配置已保存，设备重连后生效',
  'characterStyle.wavRequired': '只允许上传 WAV 录音',
  'characterStyle.audioUploadSuccess': '主录音已规范化并保存',
  'characterStyle.rolePromptPreserved': '已绑定人物风格：此角色介绍仍被保存，但当前不注入模型；解除绑定后恢复。',
  'characterStyle.templateDisabled': '绑定人物风格期间不能套用另一套完整角色模板，请先解除绑定。',
