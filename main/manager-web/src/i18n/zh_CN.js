export default {
  ...
  'persona.subtitle': '从 dot-skill 画廊或 ZIP 导入，自动编译测试，发布后即可绑定智能体。',
  ...
  'persona.importProgress': '导入、测试与发布',
  'persona.stepSource': '获取来源',
  'persona.stepCompile': '编译测试',
  'persona.stepReady': '发布',
  'persona.personaId': 'Persona ID',
  'persona.version': '版本',
  'persona.score': '质量分',
  'persona.publishGate': '发布门禁',
  ...
  'persona.publish': '发布',
  'persona.publishSuccess': '人物版本发布成功',
  'persona.publishedVersion': '当前发布版本',
  'persona.status': '状态',
  'persona.test': '测试',
  'persona.actions': '操作',
  'persona.preview': '预览',
  'persona.rollback': '回滚',
  'persona.archive': '归档',
  'persona.rollbackSuccess': '已切换到目标发布版本',
  ...
  'persona.testPassed': '场景测试通过，可以发布',
  ...
  'roleConfig.personaVersionPlaceholder': '选择固定版本（留空自动跟随当前发布版）',
  'roleConfig.openPersonaLibrary': '人物库 / 导入',
  'roleConfig.personaLatestVersion': '自动跟随当前发布版',
